...
def predict_and_render_radiance(
    ...
    if getattr(options.nerf, mode).num_fine > 0:
        ...
        delta_fine = radiance_field_fine[..., 4]
    ...
    return rgb_coarse, disp_coarse, acc_coarse, rgb_fine, disp_fine, acc_fine, delta_coarse, delta_fine, radiance_field_fine
...
def run_one_iter_of_nerf(
    ...
    if mode == "validation":
        ...
        if model_fine:
            return tuple(synthesized_images_valid + synthesized_images[6:])
        else:
